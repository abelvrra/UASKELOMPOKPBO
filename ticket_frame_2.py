...
# Katalog destinasi wisata (data statis, tidak disimpan di DataStore
# karena DataStore hanya menyimpan booking, bukan katalog produk)
DESTINATIONS = [
    {
        "icon": "🎢", "nama": "Suncity Waterpark", "harga": 35000,
        "desc": "Wahana air seru untuk keluarga dengan kolam ombak dan seluncuran.",
        "lokasi": "Jl. Yos Sudarso, Madiun", "jam_buka": "08.00 - 17.00",
        "fasilitas": "Kolam renang, food court, loker, mushola",
    },
    {
        "icon": "🍇", "nama": "Wana Wisata Grape", "harga": 10000,
        "desc": "Wisata alam dengan kebun anggur dan udara sejuk pegunungan.",
        "lokasi": "Kare, Madiun", "jam_buka": "07.00 - 16.00",
        "fasilitas": "Area petik buah, gazebo, spot foto",
    },
    {
        "icon": "🏛️", "nama": "Pahlawan Street Center", "harga": 0,
        "desc": "Pusat kuliner dan hiburan malam gratis di jantung kota Madiun.",
        "lokasi": "Jl. Pahlawan, Madiun", "jam_buka": "16.00 - 22.00",
        "fasilitas": "Panggung hiburan, kuliner kaki lima, taman",
    },
    {
        "icon": "🌳", "nama": "Hutan Kota Madiun", "harga": 5000,
        "desc": "Taman hijau di tengah kota, cocok untuk bersantai bersama keluarga.",
        "lokasi": "Jl. Diponegoro, Madiun", "jam_buka": "06.00 - 18.00",
        "fasilitas": "Jogging track, playground, area piknik",
    },
]
...
def _tanggal_hari_ini():
    ...
    return f"{now.day} {BULAN_ID[now.month - 1]} {now.year}"


def _generate_kode():
    now = datetime.datetime.now()
    return "GT" + now.strftime("%y%m%d%H%M%S") + str(random.randint(0, 9))
